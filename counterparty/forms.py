...
class CounterpartyForm(ModelForm):
	...
	class Meta:
		...
		widgets = {
			...
			'short_name':forms.TextInput(attrs={'class':'form-control mr-sm-2','placeholder':'Сокрашенное наименование', 'readonly':'readonly'}),
			'full_name':forms.TextInput(attrs={'class': 'form-control mr-sm-2','placeholder':'Полное наименование', 'readonly':'readonly'}),
