...
class SignatoryContract(models.Model):
    ...
    address_legal = models.CharField(max_length=128, verbose_name='Юридический адрес')
    address_factual = models.CharField(max_length=128, verbose_name='Фактический адрес')
